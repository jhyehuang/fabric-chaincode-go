...
import (
	//"crypto/tls"
	"github.com/jhyehuang/gm-pkg/crypto/tls"
...
func LoadConfig() (Config, error) {
	...
	if set {
		...
		chaincodeLogger.Infof("CORE_TLS_CLIENT_CERT_PATH: %s\n", os.Getenv("CORE_TLS_CLIENT_CERT_PATH"))
	...
	chaincodeLogger.Infof("CORE_PEER_TLS_ROOTCERT_FILE: %s\n", os.Getenv("CORE_PEER_TLS_ROOTCERT_FILE"))
	if err != nil {
